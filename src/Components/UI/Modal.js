        ...
        <Fade in={open}>
          <Box sx={style}>
            ...
            <Typography id="transition-modal-description" sx={{ mt: 2 }}>
              ...
              course on Udemy.
              <Typography id="transition-modal-description" sx={{ mt: 2 }}>
                This project showcases a dynamic Expense Tracker Web App built
                using React JS, enabling users to manage and track their
                expenses effortlessly with real-time insights and
                visualizations.
              </Typography>
            </Typography>
            <div
